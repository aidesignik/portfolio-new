...
export function RideBlockCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      style={style}
      className={`flex w-full min-w-0 flex-col gap-[3px] rounded-[11px] px-[11px] pb-[10px] pt-[9px] text-left transition-shadow duration-[.12s] ease-out hover:shadow-[0_2px_10px_rgba(24,24,27,.16)] ${statusStyle.card}`}
